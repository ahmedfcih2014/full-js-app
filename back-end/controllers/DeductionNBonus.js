...
export default class DeductionNBonus {
    ...
    async index(req ,res) {
        ...
        res.render(
            ...
            {title: 'Deductions And Bonuses' ,current_uri: '/deduction-bonuses' ,current_group: 'hr' ,models ,is_danger ,alert_message}
        )
    ...
    async create(req ,res) {
        ...
        res.render(
            ...
            {title: 'Deductions And Bonuses' ,current_uri: '/deduction-bonuses' ,current_group: 'hr' ,employees ,errors}
        )
        req.session.errors = []
    }
    ...
    async edit(req ,res) {
        ...
        res.render(
            ...
            {title: 'Deductions And Bonuses' ,current_uri: '/deduction-bonuses' ,current_group: 'hr' ,model ,employees ,errors}
        )
    }
