...
export default class Admins {
    ...
    async delete(req ,res) {
        ...
        if (deleted) {
            await req.flash('alert_message' ,'Admin deleted successfully from our data')
            res.send({
                location: '/admins'
            })
        } else {
    ...
    async store(req ,res) {
        ...
        if (!errors.isEmpty()) {
            ...
            await req.flash('alert_message' ,'Admin stored successfully to our data')
            res.redirect('/admins')
        }
    }
    ...
    async update(req ,res) {
        ...
        if (!errors.isEmpty()) {
            ...
            await req.flash('alert_message' ,'Admin updated successfully in our data')
            res.redirect('/admins')
            req.session.errors = null
        }
    }
